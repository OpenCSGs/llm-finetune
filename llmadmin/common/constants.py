...
LLMAdmin Explorer allows you to take a single prompt and send it to a number of open source LLMs
...
It is an open source project and you can launch your own instance of llmadmin.backend.

If you would like to use a managed version of LLMAdmin Explorer specific to your company,
please let llmadmin@anyscale.com know.
