...
class InitializationConfig(BaseModelExtended):
    initializer: Annotated[
        Union[DeepSpeed, DeviceMap, SingleDevice, Finetune, AutoModel, LlamaCpp, TransformersPipeline], Field(discriminator="type")
    ]
    pipeline: Union[Literal["default"], Literal["defaulttransformers"], Literal["llamacpp"]] = None
...
class BaseConfig(BaseModelExtended):
    ...
    save_steps: int = 500
    checkpoints_output_dir: str = "/tmp"
